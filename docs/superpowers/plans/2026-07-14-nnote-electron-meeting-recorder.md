...
npm install -D electron@43.1.0 electron-vite@5.0.0 typescript@7.0.2 vitest@4.1.10 @playwright/test@1.61.1 electron-builder@26.15.3 @vitejs/plugin-react @testing-library/react @testing-library/user-event @testing-library/jest-dom jsdom eslint
```
