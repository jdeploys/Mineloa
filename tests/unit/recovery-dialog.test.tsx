...
describe('RecoveryDialog', () => {
  ...
  it('confirms discard, cancels without deletion, and only discard is destructive', async () => {
    ...
    expect(screen.getByRole('button', { name: '복구' }).querySelector('.ui-icon')).toBeVisible()
    expect(screen.getByRole('button', { name: '현재 파일로 보관' }).querySelector('.ui-icon')).toBeVisible()
